...
class Denlac:
    ...
    def clusterDataset(self, dataset):
        ...
        pdf = self.computePdfKde(datasetXY)  # calculez functia densitate probabilitate utilizand kde
        ...
        '''
         Compute dataset pdf
        '''
        pdf = self.computePdfKde(datasetXY)  # calculez functia densitate probabilitate din nou
